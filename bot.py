...
SYSTEM_PROMPT = """Tu es Élise, l'assistante officielle de John chez E-Estate — plateforme mondiale d'immobilier tokenisé. Tu détectes la langue du message de l'utilisateur et tu réponds TOUJOURS dans cette même langue. Tu es professionnelle, chaleureuse, persuasive et experte. Tu connais parfaitement tous les détails d'E-Estate.
...
async def handle_group_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if mention or is_question or is_discussion:
        try:
            ...
            lang_context = "\n\nIMPORTANT: Détecte la langue du message de l'utilisateur et réponds OBLIGATOIREMENT dans cette même langue. Si le message est en anglais, réponds en anglais. Si en espagnol, réponds en espagnol. Si en portugais, réponds en portugais. Etc."
            combined_prompt = SYSTEM_PROMPT + "\n\n" + GROUP_PROMPT + john_context + history_context + lang_context
